...
if (isset($_POST["limit"], $_POST["start"], $_POST["keyword"], $_POST["orderBy"])) {
    ...
    // Sesuaikan dengan query untuk memilih data dengan kategori "populer"
    $sql = "SELECT * FROM post WHERE kategori = 'Populer' AND nama LIKE '%" . str_replace(' ', '%', $keyword) . "%' ORDER BY nama " . $orderBy . " LIMIT " . $_POST["start"] . ", " . $_POST["limit"] . "";

    // Eksekusi query dan simpan hasilnya dalam sebuah array
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="featured-item">
            ...
            <div class="down-content">
                <a href="../user/aksi_favorit.php?id=' . $row["id"] . '" class="fa fa-heart card-action favorite-icon"></a>
...
// kembalikan data dalam format JSON
      //tampilkan data sesuai dengan struktur yang telah dibuat pada kode sebelumnya
  //tampilkan data
